...
public class ExtentFactory {
	...
	public static String captureApplicationScrrenshot() {
	...
	public static void sendKeysFail(String Value, String elementName) {
		getInstance().getExtentTest().fail("Error occured while entering value " +Value+ " in test box"+elementName);
	...
	public static void failTest(String message) {
		getInstance().getExtentTest().fail(message, MediaEntityBuilder.createScreenCaptureFromBase64String(captureApplicationScrrenshot()).build());
